...
//     Support for member-defined named cells added as an array "namedcells"
//         Patch code for member-defined named cells supports single cells only.
...
//                    echo '<br />';
    ...
    private function loadOLE($pFilename)
    {
        ...
        // Get member-defined property data
...
//        echo '<br />';
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if (isset($this->formats[$numberFormatIndex])) {
                // then we have member-defined format code
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            // bit: 15; mask 0x8000; 0 = member-defined style, 1 = built-in style
            ...
            if ($isBuiltIn) {
                ...
                // member-defined; not supported by PHPExcel
            }
        }
    }
    ...
    private function readDefinedName()
    {
        ...
        if ($this->version == self::XLS_BIFF8) {
            ...
            // bit: 5; mask: 0x0020; 0 = member-defined name, 1 = built-in-name
...
//        echo '<br />';
    ...
    private function readSheetProtection()
    {
        ...
        // bit: 0; mask 0x0001; 1 = member may edit objects, 0 = users must not edit objects

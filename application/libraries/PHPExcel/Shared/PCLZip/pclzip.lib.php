...
//     The use of this software is at the risk of the member.
//
// --------------------------------------------------------------------------------
...
class PclZip
{
    ...
    //                                given by the member. For an extract function it is the filename
    ...
    //                            Values are :
    //                                ok : OK !
    //                                filtered : the file / dir is not extracted (filtered by member)
    ...
    //         $p_info['filename'] : Filename with full path. Given by member (add),
        ...
        for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++) {
            ...
            if ($v_extract) {
                ...
                if ($p_options[PCLZIP_OPT_EXTRACT_AS_STRING]) {
                    ...
                    // ----- Look for member callback abort
                    if ($v_result1 == 2) {
                        break;
                    }

 ...
 * It uses the Member-Agent string combined with specific HTTP headers to detect the mobile environment.
 *
...
class Mobile_detect
{
    ...
    /**
     * The Member-Agent HTTP header is stored in here.
     * @var string
     */
    ...
    protected static $uaHttpHeaders = array(
        // The default Member-Agent string.
        'HTTP_USER_AGENT',
    ...
    /**
     * The individual segments that could exist in a Member-Agent string. VER refers to the regular
     ...
     * @param string $userAgent Inject the Member-Agent header. If null, will use HTTP_USER_AGENT
     ...
     *                       "Member-Agent" or "X-Device-Member-Agent" or can be php-esque with the
     ...
     * can contain the Member-Agent string.
     *
    ...
    /**
     * Set the Member-Agent to be used.
     *
     * @param string $userAgent The member agent string to set.
     *
     * @return string|null
     */
     ...
     *
     * @return string|null The member agent if it's set.
     */
     ...
     *
     * @return array List of member agents.
     */
    ...
    /**
     * Retrieve the list of known browsers. Specifically, the member agents.
     *
     * @return array List of browsers / member agents.
     */
    ...
    /**
     * Find a detection rule that matches the current Member-agent.
     *
     ...
     * regex against the Member-Agent.
     *
     * @param string $key
     *
     * @return boolean
     ...
     * their conventions in representing the Member-Agent or
     * the HTTP headers.
     *
     * This method will be used to check custom regexes against
     * the Member-Agent string.
     *
     * @param $regex
    ...
    /**
     * Check the version of the given property in the Member-Agent.
